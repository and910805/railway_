...
def _hb_make_login_url(for_user_id: str, next_path: str = "/hb") -> str:
    return hb_feature_make_login_url(
        base_url=get_public_base_url(),
        create_magic_token=create_dashboard_magic_token,
        db_path=LOVE_DB_PATH,
        user_id=for_user_id,
        ttl_seconds=DASH_MAGIC_TOKEN_TTL_SECONDS,
        next_path=next_path,
...
def _hb_test_allowed(uid: str) -> bool:
    return hb_feature_test_allowed(
...
register_hb_routes(
    app,
    bot_name=BOT_NAME,
    love_db_path=LOVE_DB_PATH,
    dash_session_ttl_seconds=DASH_SESSION_TTL_SECONDS,
    get_public_base_url=get_public_base_url,
    consume_magic_token=consume_dashboard_magic_token,
    dash_user_allowed=_dash_user_allowed,
